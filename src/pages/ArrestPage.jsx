  ...
  return (
    <div className="arrest-modal-bg">
      <div className="arrest-modal exchange-modal">
        <div className="exchange-title">小豚換西瓜</div>
        ...
        <div className="exchange-total">總計：<img src="/images/watermelon.png" alt="西瓜" />+{watermelon}</div>
        <div className="exchange-btn-row">
          <button className="exchange-cancel-btn" onClick={onClose}>取消</button>
          <button className="exchange-confirm-btn" onClick={handleExchange} disabled={watermelon === 0}>兌換</button>
        </div>
      </div>
    </div>
  );

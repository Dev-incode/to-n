...
const TASKS = {
  ...
  Bonus: [
    ...
    { title: '幫豚保養', subtitle: '滋潤啦~~', reward: 1 },
    { title: '幫豚捏捏', subtitle: '肩頸僵硬！呃呃', reward: 1 },
    { title: '火熱氛圍', subtitle: '色色的...調情...(羞)', reward: 1 },
    { title: '乾淨豚窩', subtitle: '豚不需要自己打掃吧', reward: 1 },
    { title: '收拾行李', subtitle: '豚不需要自己收拾吧', reward: 1 },
    { title: '摸摸按鈕2', subtitle: '摸摸！摸摸！15分鐘！', reward: 1 },
    { title: '摸摸按鈕3', subtitle: '摸摸！摸摸！20分鐘！', reward: 1 },
  ],
};

...
test("simple one address function", function (t) {
    ...
    result = fxn("\"Fran癟oise Lef癡vre\"@example.com");
    t.ok(result, "RFC 6532 (Unicode support) is enabled by default");
    t.equal(result.parts.local.semantic, "Fran癟oise Lef癡vre");
...
test("rfc5322 parser", function (t) {
    ...
    result = fxn({ input: "\"Fran癟oise Lef癡vre\"@example.com", rfc6532: true });
...
test("unicode support", function (t) {
    ...
    result = fxn("?典?摰?<xiaoyu@example.com>");
